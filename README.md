...
### The easy and secure Pyeongtaekcoin wallet

LoafWallet is the best way to get started with Pyeongtaekcoin. Our simple, streamlined design is easy for beginners, yet powerful enough for experienced users. This is a port of the LoafWallet for iOS app which can be found here: https://github.com/pyeongtaekcoin-foundation/loafwallet-ios

##### Completely decentralized

Unlike other iOS Pyeongtaekcoin wallets, **LoafWallet** is a standalone Pyeongtaekcoin client. It connects directly to the Pyeongtaekcoin network using [SPV](https://en.bitcoin.it/wiki/Thin_Client_Security#Header-Only_Clients) mode, and doesn't rely on servers that can be hacked or disabled. Even if LoafWallet is removed from the App Store, the app will continue to function, allowing users to access their money at any time.
